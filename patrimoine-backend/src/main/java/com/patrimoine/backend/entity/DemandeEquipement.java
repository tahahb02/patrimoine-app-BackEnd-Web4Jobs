...
public class DemandeEquipement {
    ...
    @Column(name = "statut")
    private String statut = "EN_ATTENTE"; // Par défaut, la demande est en attente
    ...
    public String getCategorieEquipement() {
        return categorieEquipement;
    }

    public void setCategorieEquipement(String categorieEquipement) {
        this.categorieEquipement = categorieEquipement;
    }

    public String getCentreEquipement() {
        return centreEquipement;
    }

    public void setCentreEquipement(String centreEquipement) {
        this.centreEquipement = centreEquipement;
    }
